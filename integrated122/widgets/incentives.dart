        ...
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                Text('Points: ${incentive['points']?.toString() ?? ''}', style: const TextStyle(color: AppColors.darkBlue)),
                if (incentive['assignedAt'] != null)
                  Text('Assigned At: ${incentive['assignedAt']}', style: const TextStyle(color: AppColors.darkBlue)),
                if (incentive['assignedBy'] != null)
                  Text('Assigned By: ${incentive['assignedBy']}', style: const TextStyle(color: AppColors.darkBlue)),
              ],
            ),
          ),
        );
